...
public class binsy {
	...
	static void problem1()
	{
		...
		System.out.println("The sum of "+num1 + " and " + num2 + " is "+ans );in.close();
	...
	static void problem2()
	{
		...
		System.out.println("The difference of "+num1 + " and " + num2 + " is "+ans );in.close();
	...
	static void problem3()
	{
		...
		System.out.println("The product of "+num1 + " and " + num2 + " is "+ans );in.close();
	...
	static void problem4()
	{
		...
		System.out.println("The quotient of "+num1 + " and " + num2 + " is "+ans );in.close();
	...
	static void problem5()
	{
		...
		System.out.println("The area of triangle with base of "+base + " and height of " + height + " is "+area );in.close();
	...
	static void problem6()
	{
		...
		System.out.println("Your name is "+name + " and your age is " + age);in.close();
	...
	static void problem8()
	{
		...
		System.out.println("The volume of sphere with radius of "+rad +" is " + vol);in.close();
	}
	...
	static void problem9()
	{
		...
		System.out.println("The area of circle with radius of "+rad +" is " + vol);in.close();
	}
